               ...
               <div className="max-w-4xl mx-auto space-y-8">
                  ...
                  <div className="grid md:grid-cols-3 gap-6">
                     {[
                        ...
                        <div key={scope.id} className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <div className="flex items-center justify-between p-5 bg-white rounded-xl border border-gray-200 shadow-sm">
                     <div className="flex items-center space-x-3 overflow-hidden">
                        ...
                        <code className="bg-slate-100 px-3 py-1.5 rounded-lg text-slate-800 font-mono text-sm truncate">chmod {getOctal()} filename.txt</code>
                     </div>
                     <ActionButton
