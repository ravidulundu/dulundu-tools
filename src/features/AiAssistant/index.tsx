      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
        <div className="p-6 border-b border-gray-100 flex items-center space-x-3 bg-slate-50/50">
           ...
           <div>
              ...
              <p className="text-sm text-slate-500">Powered by Google Gemini - Ask anything about code</p>
           </div>
        </div>
        ...
        <div className="p-6 bg-gradient-to-r from-slate-50 to-blue-50/30">
          ...
          <div className="flex gap-2 mt-3 overflow-x-auto pb-2 scrollbar-hide">
            {['Regex for email', 'React fetch hook', 'Center a div CSS', 'SQL Join types'].map((suggestion) => (
              <button
                key={suggestion}
