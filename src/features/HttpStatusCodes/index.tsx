            ...
            <div className="flex-1 overflow-hidden flex flex-col">
               ...
               <div className="flex-1 overflow-y-auto p-4 md:p-6 bg-gray-50/30">
                  <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-6xl mx-auto">
                     {filtered.map((item) => (
                        <div key={item.code} className="p-5 border border-gray-200 rounded-xl hover:shadow-md transition-all bg-white flex flex-col h-full group">
                           ...
                           <h3 className="font-bold text-slate-800 text-lg mb-2 group-hover:text-primary transition-colors">{item.title}</h3>
