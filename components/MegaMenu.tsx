...
const MegaMenu: React.FC<MegaMenuProps> = ({ isOpen, onClose }) => {
    ...
    return (
        <div className={`absolute top-full left-1/2 -translate-x-1/2 mt-0 w-[90vw] max-w-[900px] bg-white dark:bg-slate-800 rounded-xl shadow-2xl border border-gray-100 dark:border-slate-700 transition-all duration-200 transform p-6 z-50 ${isOpen
