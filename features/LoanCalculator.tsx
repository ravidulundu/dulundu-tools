    ...
    <div className="max-w-6xl mx-auto px-4 py-8">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div className="p-6 border-b border-gray-100 flex items-center space-x-3 bg-slate-50/50">
           ...
           <div>
              <h1 className="text-2xl font-bold text-slate-800">Loan Calculator</h1>
              <p className="text-sm text-slate-500">Professional Mortgage & Amortization Calculator</p>
           </div>
        </div>
        ...
        <div className="p-6 lg:p-8">
          <div className="grid lg:grid-cols-12 gap-8 md:gap-12">
             ...
             <div className="lg:col-span-4 space-y-8">
                <div className="p-6 bg-slate-50 rounded-2xl border border-gray-100 space-y-6">
                    <div>
