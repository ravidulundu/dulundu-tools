        ...
        {activeTab === 'preview' ? (
          <div className="bg-white dark:bg-slate-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4 min-h-full">
            <div 
              ...
              dangerouslySetInnerHTML={{ __html: html || '<p class="text-gray-500 dark:text-slate-400">No sections selected. Click sections on the left to add them to your README.</p>' }}
            />
          </div>
        ) : (
          <div className="bg-white dark:bg-slate-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4 min-h-full">
