               ...
               <div className="max-w-5xl mx-auto space-y-8">
                  ...
                  <div className="grid md:grid-cols-2 gap-8">
                     <div className="p-6 bg-white rounded-xl border border-gray-200 shadow-sm">
                        <label className="block text-xs font-bold text-slate-500 uppercase mb-2 tracking-wide">Number A</label>
                     ...
                     <div className="p-6 bg-white rounded-xl border border-gray-200 shadow-sm">
                        <label className="block text-xs font-bold text-slate-500 uppercase mb-2 tracking-wide">Number B</label>
                        <div className="space-y-3">
                           <input
                  ...
                  <div className="grid gap-4">
                     <h3 className="font-bold text-slate-800 text-sm uppercase tracking-wide border-b border-gray-200 pb-2">Results</h3>
                     <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {[
                           ...
                           <div key={op.label} className="p-4 bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-md hover:border-primary/30 transition-all">
                              ...
                              <div className="text-[10px] font-mono text-slate-400 break-all bg-slate-50 p-1.5 rounded">{toBin(op.val)}</div>
                           </div>
                        ))}
                     </div>
                  </div>
