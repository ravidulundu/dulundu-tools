            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                <div className="p-6 border-b border-gray-100 flex items-center justify-between bg-slate-50/50">
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold text-slate-800">Word to HTML</h1>
                            <p className="text-sm text-slate-500">Paste Word document content to get clean HTML</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="p-6 grid md:grid-cols-2 gap-6">
                    <div className="flex flex-col h-full">
                        <div className="flex items-center justify-between mb-2">
                            <label className="block text-sm font-medium text-slate-700">Visual Editor (Paste here)</label>
                            <button
                                onClick={() => {
                                    if (editorRef.current) {
