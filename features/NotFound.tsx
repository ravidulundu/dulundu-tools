        ...
        <div className="min-h-[70vh] flex flex-col items-center justify-center p-4 text-center">
            ...
            <div className="w-full max-w-md mb-8">
                <svg viewBox="0 0 400 300" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
                    <path d="M200 50C117.157 50 50 117.157 50 200H350C350 117.157 282.843 50 200 50Z" fill="#E2E8F0" className="dark:fill-slate-800" />
                    <circle cx="200" cy="200" r="150" fill="#F1F5F9" className="dark:fill-slate-700" />
                    <circle cx="150" cy="180" r="15" fill="#94A3B8" className="dark:fill-slate-500 animate-pulse" />
                    <circle cx="250" cy="180" r="15" fill="#94A3B8" className="dark:fill-slate-500 animate-pulse" />
                    <path d="M170 240C170 240 180 230 200 230C220 230 230 240 230 240" stroke="#94A3B8" strokeWidth="8" strokeLinecap="round" className="dark:stroke-slate-500" />
                    <text x="200" y="140" textAnchor="middle" fontSize="60" fontWeight="bold" fill="#3B82F6" className="font-sans">404</text>
                </svg>
            </div>
